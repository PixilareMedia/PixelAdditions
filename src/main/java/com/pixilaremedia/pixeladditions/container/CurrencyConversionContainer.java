...
public class CurrencyConversionContainer extends AbstractContainerMenu {
    ...
    public CurrencyConversionContainer(int id, Inventory playerInventory) {
        this(id, playerInventory, ContainerLevelAccess.NULL);
    }

    public CurrencyConversionContainer(int id, Inventory playerInventory, final ContainerLevelAccess access) {
        super(MenuTypeRegistry.CURRENCY_CONVERSION.get(), id);
        this.access = access;
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(this.access, playerIn, CurrencyRegistry.BLOCK_CURRENCY_CONVERSION_TABLE.get());
    }
    ...
    private void setupRecipeList(Container inventoryIn, ItemStack stack) {
        ...
        this.recipes = stack.isEmpty() ? Collections.emptyList() : RecipeHelper.getSortedMatchingRecipesCurrency(this.level, inventoryIn);
    }
    ...
    public MenuType<?> getType() {
        return MenuTypeRegistry.CURRENCY_CONVERSION.get();
    }
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(RecipeTypeRegistry.CURRENCY_CONVERSION, new SimpleContainer(itemstack1), this.level).isPresent()) {
